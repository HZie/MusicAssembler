    ...
    public class MidiScan
    {
        ...
        static public void DebugMidiSorted(List<TrackMidiEvent> MidiSorted)
        {
            foreach (TrackMidiEvent midievent in MidiSorted)
            {
                ...
                //        break;
                //}
                Debug.Log(string.Format("[{0,5:00000}] [T:{1,2:00} C:{2,2:00}] ", midievent.Event.AbsoluteTime, midievent.IndexTrack, midievent.Event.Channel) + midievent.Event.ToString());
            }
        }
