...
namespace CSharpSynth.Synthesis
{
    ...
    {
        private byte currentNote, currentChannel;
        private byte currentNoteOff, currentChannelOff;
        ...
        public byte CurrentNote { get { return currentNote; } }
        public byte CurrentChannel { get { return currentChannel; } }
        public byte CurrentNoteOff { get { return currentNoteOff; } }
        public byte CurrentChannelOff { get { return currentChannelOff; } }
        ...
        public void NoteOn(int channel, int note, int velocity, int program)
        {
            ...
            //Debug.Log("noteregskey " + r.Note + "channel: " + r.Channel);
            currentNote = r.Note;
        ...
        {
            NoteRegistryKey r = new NoteRegistryKey((byte)channel, (byte)note);
            currentNoteOff = r.Note;
            currentChannelOff = r.Channel;
